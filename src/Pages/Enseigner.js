        ...
        <div className="mt-2 mb-2 flex flex-col items-center justify-center relative isolate px-6 pt-14 lg:px-8 px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            ...
            <div className="text-left mb-6">
                <p className="mt-6 text-s leading-8 text-justify">
                    La première étape, pour devenir enseignant, est d'obtenir une licence (Bac+3). Dès la licence, des parcours ou options de préparation aux métiers de l'enseignement sont proposés aux étudiants qui désirent s'engager dans cette voie.
                </p>
            </div>
            <div className="text-left mb-6">
                <p className="mt-6 text-s leading-8 text-justify">
            ...
            <div className="text-left mb-6">
                <p className="mt-6 text-s leading-8 text-justify">
                    ...
                    <a href="http://www.devenirenseignant.gouv.fr/pid33985/enseigner-au-college-ou-au-lycee-general-le-capes.html"> http://www.devenirenseignant.gouv.fr/pid33985/enseigner-au-college-ou-au-lycee-general-le-capes.html</a>
                </p>
            </div>
        </div>
    );
